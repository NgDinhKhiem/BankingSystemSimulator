            ...
            public void mouseClicked(MouseEvent e) {
                ...
                HttpUtils.sendGETRequest(requestBuilder.getRequest()).thenAccept(response -> {
                    ...
                    if(registrationResponse.state){
                        ...
                        Client.this.sectionToken = registrationResponse.getToken();
        ...
        registerButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                HttpUtils.sendGETRequest(requestBuilder.getRequest()).thenAccept(response -> {
                    ...
                    if(registrationResponse.state){
                        announcementLabel.setText("Registered Successfully Here is your ID: "+ registrationResponse.getID());
                        grayBlock.add(announcementLabel);
                        grayBlock.revalidate();
                        grayBlock.repaint();
                    }else {
    ...
    private void intoTheMainMenu() {
        ...
        HttpUtils.sendGETRequest(requestBuilder.getRequest()).thenAccept(response -> {
            ...
            if(registrationResponse.isState()){
                userID.setText(registrationResponse.getID());
                userName.setText(registrationResponse.getLastName() +" "+ registrationResponse.getFirstName());
                userEmail.setText(registrationResponse.getEmail());
                userPhone.setText(registrationResponse.getPhoneNumber());
                frame.repaint();
                frame.revalidate();
            }else {
                frame.dispose();
